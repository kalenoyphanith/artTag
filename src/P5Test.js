                ...
                <button className="toolButton" onClick={resetSketch}><img src={trash} width="auto" id="trash-button"/></button>
                    ...
                    >
                        <span className="brushes">
                            <img className="brushImg" src={fountain} onClick={()=>{console.log("fountain"); type = "fountain"; fountainPen();}}></img>
                            <img className="brushImg" src={markerBrush} onClick={()=>{console.log("marker"); type = "marker"; marker();}}></img>
